...
class acror_test(models.Model):

    last_name = models.CharField(max_length=100, primary_key=True)
    actors_with_lastname= models.IntegerField(blank=True, null=True)
...
class FilmActor(models.Model):
    ...
    film = models.ForeignKey(Film, models.DO_NOTHING,related_name='tracks')
    last_update = models.DateTimeField()
...
class actor_CONCAT(models.Model):

    Actor_Name = models.CharField(max_length=100, primary_key=True)


    class Meta:
        managed = False
        db_table = 'actor_CONCAT'

class actor_first_name(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'actor_first_name'

class S_first_name(models.Model):
    first_name = models.CharField(max_length=100, primary_key=True)
    last_name = models.CharField(max_length=100)
    ...
    class Meta:
        managed = False
        db_table = 'S_first_name'

class Store_City(models.Model):
    Store_Number = models.CharField(max_length=100, primary_key=True)
...
class Number_of_times(models.Model):
    film_id = models.IntegerField()
    title = models.CharField(max_length=100,primary_key=True)
    Number_of_times_rented = models.CharField(max_length=100)

    class Meta:
        managed = False
        db_table = 'Number_of_times'

class Canada_n(models.Model):
    first_name = models.CharField(max_length=100,primary_key=True)
    last_name = models.CharField(max_length=100)
...
class actor_count(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'actor_count'

class first_pay(models.Model):
    first_name = models.CharField(max_length=100,primary_key=True)
    last_name = models.CharField(max_length=100)

    total_amount_paid = models.DecimalField(max_digits=5, decimal_places=2)
...
class COUNT_name(models.Model):

    last_name = models.CharField(max_length=100, primary_key=True)
    actors_with_this_lastname = models.IntegerField()
...
class first_name_LI(models.Model):
    first_name= models.CharField(max_length=100, primary_key=True)
    last_name =  models.CharField(max_length=100)
