...
def test_make_valley(benchmark):
    ...
    assert benchmark(make_valley,[20, 18, 17, 13, 12, 12, 10, 9, 4, 2, 2, 1, 1])== [20, 17, 12, 10, 4, 2, 1, 1, 2, 9, 12, 13, 18]
    ...
    assert benchmark(make_valley,[20, 18, 16, 15, 14, 14, 13, 13, 10, 9, 4, 4, 4, 1])== [20, 16, 14, 13, 10, 4, 4, 1, 4, 9, 13, 14, 15, 18]
